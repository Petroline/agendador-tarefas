...
import com.petroline.agendadortarefas.business.mapper.TarefaUpdateConverter;
import com.petroline.agendadortarefas.business.mapper.TarefasConverter;
...
import com.petroline.agendadortarefas.infrastructure.exceptions.ResourceNotFoundException;
...
public class TarefasService {
    ...
    public TarefasDTO updateTarefas(TarefasDTO dto, String id) {
        try {
            TarefasEntity entity = tarefasRepository.findById(id).
                    orElseThrow(() -> new ResourceNotFoundException("Tarefa nao encpontrada" + id));
